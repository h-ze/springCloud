...
public final strictfp class MathUtil {
	...
	public static final Double divide(Object num1, Object num2) {
		if(ObjectUtils.isEmpty(num2)){
			throw new IllegalArgumentException("The Dividend cannot be empty");
		}
		if(bigDecimal(num2).doubleValue()==0){
	 ...
	 * eg:23.65%
	 */
	public static final String numberToPercent(Object object) {
